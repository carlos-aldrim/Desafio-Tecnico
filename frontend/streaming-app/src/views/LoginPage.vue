    ...
    <div class="w-full max-w-md bg-white rounded-xl shadow-lg p-8">
      ...
      <form @submit.prevent="handleLogin" class="space-y-6">
        <div>
          ...
          <input v-model="email" id="email" type="email" required placeholder="seu.email@exemplo.com"
      ...
      <router-link to="/register" class="block text-center text-sm text-indigo-600 mt-2">
